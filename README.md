# genpark-unified-llm-alignment-dpo-lora-training-suite-skill
...
> **GenPark AI Agent Skill** -- Unified LLM alignment suite orchestrating DPO & LoRA runs (Llama-Factory style)
